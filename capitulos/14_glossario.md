...
* **Registradores**: Pequenos compartimentos internos de armazenamento temporário ultrarrápido dentro do chip. No Z80, guardam números inteiros de 8 bits (de 0 a 255). (*Metáfora: A gaveta secreta onde o chip guarda números que não pode esquecer de jeito nenhum.*)
...
* **Odometria**: Estimativa da distância percorrida pelo veículo calculada com base na rotação das rodas monitorada por sensores (encoders). Sujeita a desvios por derrapagem. (*Metáfora: O jeito do robô medir passos, como um pedômetro elétrico.*)
